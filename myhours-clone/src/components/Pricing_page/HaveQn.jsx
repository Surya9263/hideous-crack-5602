...
function HaveQn() {
  return (
    <Box  w="100%" m="auto"  textAlign="center">
      ...
      <Box className={style.haveqnhead} m="1rem auto"  color="#212529" fontSize="18px" lineHeight="1.5">
        It's always nice to have someone to talk to when facing new software.
        Get in touch and we'll try our best to help you out.
      </Box>

      
      <Box className={style.haveqnlinks} pl="1rem" textAlign="center" display="flex" >
