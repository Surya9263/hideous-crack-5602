...
=======
    return (
        <>
            <Box className={style.parent} >
              <p className={style.parentHead} style={{fontWeight:"lighter"}}><span className={style.parentSpan} style={{ fontWeight:"bolder"}}>Organize </span>projects,<span style={{fontWeight:"bolder"}}> Track</span> time and <span style={{ fontWeight:"bolder"}}>Report</span> your work</p>
            </Box>
            <Box className={style.parent}>
              <p style={{fontFamily:'Avenir Next',fontSize:"28px", color:"rgb(55, 93, 117)"}}>Coordinate projects and tasks. Track your work hours and create awesome-looking reports for clients.<span style={{fontWeight:"bolder"}}> All-in-one free time tracking software.</span></p>
            </Box>
            ...
            <Flex className={style.flexClass} justifyContent="space-between" gap="5rem">
            ...
            <Flex className={style.flexClassReverse} justifyContent="space-between" gap="2rem" mt="100px">
            ...
            <Flex className={style.flexClass} justifyContent="space-between" mt="100px" gap="2rem" alignItems="center">
                <Box className={style.flexBox1}>
                    <Text style={{fontFamily:'Avenir Next',fontSize:"28px", color:"rgb(55, 93, 117)",textAlign:"left", fontWeight:"bolder"}} >Create great-looking reports</Text>
                    <Text fontSize="18px" mb="20px">Turn your work into dazzling reports with confidence. From Dashboard to more advanced time analytics. No need for extra spreadsheet work, even though you can export your data.</Text>
                    <Text as="i" color="rgb(55, 93, 117)" fontFamily="Avenir Next" fontSize="larger" fontWeight="semibold">“My Hours is a super easy to use time tracker and great for sending hourly reports to clients for billable work” - Erin A. Business owner</Text>
            ...
            <Flex justifyContent="center" gap="15px" alignItems="center">
                ...
                <Box>
>>>>>>> d8fd412d7d220a15524241b166ba650a6c93c0eb
                <img style={{width:"25px"}} src="https://uploads-ssl.webflow.com/5c77a918ef19681741be7bca/609937875793cc93f40c3a44_vectorpaint.svg" alt="" />
                </Box>
            </Flex>
            <Box>
            ...
            <Flex className={style.flexClass2} my="50px" justifyContent="space-between" gap="2rem" textAlign="center" color="rgb(55, 93, 117)">
            ...
            <Flex className={style.flexClass2} mb="85px" alignItems="center" justifyContent="space-between" gap="2rem" textAlign="center" color="rgb(55, 93, 117)">
              <Box className={style.flexBox5}>
                <Text fontSize="25px" fontWeight="bold">Attendance</Text>
                <Text fontSize="20px" fontWeight="semibold">We need to track employee attendance/absence and tasks.</Text>
                <a className={style.anchorTagsHover} href="#" style={{fontSize:"18px"}}>Here's how</a>
        ...
        Our software <span style={{textDecoration:"underline"}}>does not include employee monitoring</span> and never will.</Text>
            ...
            <Flex className={style.flexClass2} justifyContent="space-between" gap="2rem" fontSize="18px" textAlign="left">
                <Box className={style.flexBox5}>
                    <Text>
            ...
            <Flex className={style.flexClass2} justifyContent="space-between" gap="2rem" fontSize="18px" textAlign="left" my="20px">
                <Box className={style.flexBox5}>
                    <Text>
            ...
            <Flex className={style.flexClass2} justifyContent="center" gap="1rem"  color="rgb(59, 143, 194)">
                <Box>
            ...
            <Flex className={style.flexClass4} mt="180px" mb="100px" justifyContent="center" gap="20px">
                <Box className={style.flexBox6} backgroundColor="#f8fafb" px="80px" py="50px" textAlign="center">
                ...
                <Box className={style.flexBox7} backgroundColor="#faf9f7" py="50px" px="80px" color="rgb(55, 93, 117)" textAlign="left">
